...
class ClickableMenuItem extends FunctionMenuItem {
	constructor(menu, options) {
		...
		addEventListener(rowElement, 'contextmenu', STOP_AND_PREVENT);
...
class MenuBar {
	constructor() {
		...
		addEventListener(container, 'contextmenu', STOP_AND_PREVENT);
...
export { index as Bar, index$1 as MenuItem, closeAllMenu, popup };
